...
class CatalogTests(unittest.TestCase):
    ...
    def test_ui_has_personalization_and_current_counts(self) -> None:
        ...
        for marker in ('id="tool-count-hero">92</b> TOOLS INDEXED', "DEFENSE / 50", 'data-filter="favorites"', 'data-filter="recent"', 'data-columns="5"'):
            self.assertIn(marker, html)
        for marker in ("favoriteTools", "recentTools", "setColumns", "scheduleToolRender"):
